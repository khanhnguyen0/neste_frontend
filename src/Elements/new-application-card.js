    ...
    <div className = "application-card" style = {{"borderLeftColor":color}}>
      ...
      <div id="info-row">
        ...
        <div>
          ...
          <p><i className="fa fa-file-text-o" aria-hidden="true"></i> {cert_no}/{cert_no+Math.floor(Math.random()*3)}</p>
        </div>
        <div>
          <p><i className="fa fa-paperclip" aria-hidden="true"></i> {doc_fulfilled}/{doc_fulfilled+Math.floor(Math.random()*3)}</p>
