...
const SupplierRow = (props) =>{
  let {code,start_date,end_date,expired_certification_no,selectSupplier, color} = props;
  ...
  return (
    <div className = "supplier-row" onClick = {()=>{selectSupplier(code)}} style = {{borderLeftColor:color}}>
      <div className = "code">
        <p>{code}</p>
      </div>
